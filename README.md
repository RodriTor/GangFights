...
* **Framework Multimedia:** [LibGDX](https://libgdx.com/) **1.14.2** (Módulos: *Core* para lógica compartida y *LWJGL3* para el backend de escritorio).
...
```bash
git clone https://github.com/RodriTor/GangFights.git
```
...
* Seleccioná la carpeta raíz del proyecto.
* Esperá a que Gradle descargue todas las dependencias necesarias.
...
### 4. Ejecutar el Videojuego desde la Terminal
...
Buscá la clase `Lwjgl3Launcher.java` ubicada en:
